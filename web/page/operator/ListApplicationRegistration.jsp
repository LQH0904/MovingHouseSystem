                        ...
                        <div class="col-md-3">
                            <a href="listApplication?status=all&keyword=${keyword}" class="text-decoration-none">
                                <div class="card shadow-sm border-0 bg-info text-white summary-card">
                                    <div class="card-body">
                                        <h4>${total}</h4>
                                        <p class="mb-0"><i class="bi bi-people"></i> Đơn Vị</p>
                                    </div>
                                </div>
                            </a>
                        </div>
                        <div class="col-md-3">
                            <a href="listApplication?status=pending&keyword=${keyword}" class="text-decoration-none">
                                <div class="card shadow-sm border-0 bg-warning text-dark summary-card">
                                    <div class="card-body">
                                        <h4>${pending}</h4>
                                        <p class="mb-0"><i class="bi bi-hourglass-split"></i> Đang Chờ</p>
                                    </div>
                                </div>
                            </a>
                        </div>
                        <div class="col-md-3">
                            <a href="listApplication?status=approved&keyword=${keyword}" class="text-decoration-none">
                                <div class="card shadow-sm border-0 bg-success text-white summary-card">
                                    <div class="card-body">
                                        <h4>${approved}</h4>
                                        <p class="mb-0"><i class="bi bi-check-circle"></i>Đã duyệt</p>
                                    </div>
                                </div>
                            </a>
                        </div>
                        <div class="col-md-3">
                            <a href="listApplication?status=rejected&keyword=${keyword}" class="text-decoration-none">
                                <div class="card shadow-sm border-0 bg-danger text-white summary-card">
                                    <div class="card-body">
                                        <h4>${rejected}</h4>
                                        <p class="mb-0"><i class="bi bi-x-circle"></i> Từ chối</p>
                                    </div>
                                </div>
                            </a>
                        </div>
                    ...
                    <div class="card shadow main-card">
                        <div class="card-header d-flex justify-content-between align-items-center flex-wrap">
                            <h5 class="mb-2 mb-md-0 card-title">
                                <i class="bi bi-list-check me-2"></i>Danh Sách Các Đơn Vị Đăng Kí
                            </h5>
                            <!-- Search Form -->
                            <form class="search-glass d-flex align-items-center" method="get" action="${pageContext.request.contextPath}/operator/listApplication">
                                ...
                                <input type="text" name="keyword" class="glass-input" placeholder="Tìm kiếm " value="${keyword}">
                            ...
                            <c:choose>
                                <c:when test="${empty applications}">
                                    <div class="empty-state text-center py-5 text-muted">
                                        ...
                                        <h4>Không có đơn vị nào phù hợp </h4>
                                    </div>
                                </c:when>
                                <c:otherwise>
                                        ...
                                        <table class="table table-hover align-middle data-table">
                                            <thead class="table-header">
                                                <tr>
                                                    ...
                                                    <th scope="col" width="35%"><i class="bi bi-building"></i> Tên </th>
                                                    <th scope="col" width="20%"><i class="bi bi-briefcase"></i> Loại</th>
                                                    <th scope="col" width="20%"><i class="bi bi-bar-chart"></i> Trạng Thái</th>
                                                    <th scope="col" width="15%"><i class="bi bi-tools"></i> Thao Tác</th>
                                                </tr>
                                            </thead>
                                            <tbody>
                            ...
                            <div class="pagination-wrapper">
                                <ul class="custom-pagination">
                                    <c:if test="${currentPage > 1}">
                                        <li>
                                            <a href="${pageContext.request.contextPath}/operator/listApplication?page=${currentPage - 1}&keyword=${keyword}&status=${status}">
                                    ...
                                    <c:forEach begin="1" end="${totalPages}" var="i">
                                        <li class="${i == currentPage ? 'active' : ''}">
                                            <a href="${pageContext.request.contextPath}/operator/listApplication?page=${i}&keyword=${keyword}&status=${status}">
                                                ${i}
                                            </a>
                                        </li>
                                    </c:forEach>
