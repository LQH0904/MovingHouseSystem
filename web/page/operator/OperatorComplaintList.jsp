    ...
    <body>
        <div class="parent">
            ...
            <div class="div3">
                ...
                <!-- From Uiverse.io by FColombati --> 
                <a href="http://localhost:9999/HouseMovingSystem/operator/alert-complaint" style="text-decoration: none;">               
<button class="button">
  <div class="button-outer">
    <div class="button-inner">
        <span style="color: red; font-weight: 600; width: 155px; text-align: center;">Cảnh báo</span>
    </div>
  </div>
</button>
                    </a> 
