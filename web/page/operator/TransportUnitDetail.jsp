                    ...
                    <div class="detail-container fade-in">
                        ...
                        <div class="action-buttons">
                            <c:if test='${unitT.registrationStatus == "pending"}'>
                                <form method="post" action="${pageContext.request.contextPath}/operator/application-status" style="display:inline;">
                                    <input type="hidden" name="action" value="approve">
                                    <input type="hidden" name="id" value="${unitT.transportUnitId}">
