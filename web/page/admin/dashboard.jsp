    ...
    <body>
        ...
        <div class="container">
            <div class="logout-link">
                <p>Xin chào, <%= loggedInUser.getUsername() %> ! <a href="http://localhost:9999/HouseMovingSystem/logout">Đăng xuất</a></p>
            </div>
            ...
            <div class="function-list nav-links">
                <ul>
                    <li><a href="http://localhost:9999/HouseMovingSystem/LogViewerServlet?type=system">Xem Nhật ký Hoạt động Hệ thống</a></li>
                    <li><a href="http://localhost:9999/HouseMovingSystem/LogViewerServlet?type=data_change">Xem Nhật ký Thay đổi Dữ liệu</a></li>
                </ul>
            </div>
