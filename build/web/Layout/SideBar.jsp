        ...
        <div class="sidebar">
            ...
            <div class="sidebar-content">
                <ul class="lists">
                    ...
                    <li class="list">
                        <a href="http://localhost:8082/HouseMovingSystem_HE182014/invRURL" class="nav-link">
                    ...
                    <li class="list">
                        <a href="http://localhost:8082/HouseMovingSystem_HE182014/repURL" class="nav-link">
