<%-- 
    Document   : confirm_storage
    Created on : Jun 17, 2025, 03:45:00 AM
--%>
...
<head>
    ...
    <title>Xác nhận Đăng ký Đơn vị Kho bãi</title>
...
<body>
    <div class="confirm-container animate__animated animate__fadeIn">
        ...
        <% } else { %>
        <form action="signup_storage" method="post" id="confirmForm" novalidate>
    ...
    <script>
        ...
        function resendCode() {
            ...
            $.ajax({
                url: '${pageContext.request.contextPath}/signup_storage',
                type: 'POST',
                data: { action: 'resend' },
