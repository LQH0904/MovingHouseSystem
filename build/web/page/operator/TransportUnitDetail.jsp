...
<body>
            ...
            <div class="detail-container fade-in">
                ...
                <div class="detail-content">
                    ...
                    <div class="stats-section">
                        <h2 class="section-title" style="color: white; border-bottom-color: rgba(255,255,255,0.2);">
                        ...
                        <div class="stats-grid">
                            <div class="stat-card">
                                ...
                                <div class="stat-label">Số xe</div>
                            </div>
                            <div class="stat-card">
                                <div class="stat-number">
                            ...
                            <div class="stat-card">
                                ...
                                <div class="stat-label">Bốc vác</div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="info-section">
                        ...
                        <div class="detail-grid">
                            <div class="detail-item">
                                ...
                                <span class="detail-value">${unitT.transportUnitId}</span>
                            </div>
                            ...
                            <div class="detail-item">
                                ...
                                <span class="detail-value">${unitT.username}</span>
                            </div>
                            ...
                            <div class="detail-item">
                                ...
                                <span class="detail-value">${unitT.email}</span>
                            </div>
                            ...
                            <div class="detail-item">
                                ...
                                <span class="detail-value">${unitT.companyName}</span>
                            </div>
                            ...
                            <div class="detail-item">
                                ...
                                <span class="detail-value">${unitT.contactInfo}</span>
                            </div>
                            ...
                            <div class="detail-item">
                                ...
                                <span class="detail-value">
                                    <span class="status-badge 
                                        <c:choose>
                                            <c:when test='${unitT.registrationStatus == "pending"}'>status-pending</c:when>
                                            <c:when test='${unitT.registrationStatus == "approved"}'>status-approved</c:when>
                                            <c:when test='${unitT.registrationStatus == "rejected"}'>status-rejected</c:when>
                                        </c:choose>">
                                        <c:choose>
                                            <c:when test='${unitT.registrationStatus == "pending"}'>
                                                <i class="fas fa-clock"></i> Chờ duyệt
                                            </c:when>
                                            <c:when test='${unitT.registrationStatus == "approved"}'>
                                                <i class="fas fa-check"></i> Đã duyệt
                                            </c:when>
                                            <c:when test='${unitT.registrationStatus == "rejected"}'>
                            ...
                            <div class="detail-item">
                                ...
                                <span class="detail-value">
                                    <fmt:formatDate value="${unitT.createdAt}" pattern="dd/MM/yyyy HH:mm:ss"/>
                                </span>
                            </div>
                            ...
                            <div class="detail-item">
                                ...
                                <span class="detail-value">
                                    <fmt:formatDate value="${unitT.updatedAt}" pattern="dd/MM/yyyy HH:mm:ss"/>
                                </span>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="action-buttons">
                        <c:if test='${unitT.registrationStatus == "pending"}'>
    ...
    <div id="imageModal" class="modal">
        <div class="image-modal-content">
            ...
            <div class="image-modal-footer">
                <h4 id="imageTitle" style="margin-bottom: 15px; color: #2c3e50;"></h4>
                <button class="btn btn-back" onclick="closeImageModal()">
                    <i class="fas fa-times"></i>
                    Đóng
                </button>
            </div>
    ...
    function confirmAction() {
        // Hiển thị loading
        document.querySelector('.detail-container').classList.add('loading');
        
        const form = document.createElement('form');
        form.method = 'POST';
        form.action = 'update-transport-status';
        
        const transportIdInput = document.createElement('input');
        transportIdInput.type = 'hidden';
        transportIdInput.name = 'transport_unit_id';
        transportIdInput.value = '${transportUnit.transport_unit_id}';
        ...
        form.appendChild(transportIdInput);
