...
public class TransportReportDAO {
    ...
    public TransportReport getReportById(int reportId) throws SQLException {
    ...
    public List<TransportReport> getRecentReports(int page, int pageSize, String unitName) throws SQLException {
        List<TransportReport> reports = new ArrayList<>();
    ...
    public List<TransportReport> getReportsByTransportUnit(int transportUnitId) {
        List<TransportReport> reports = new ArrayList<>();
